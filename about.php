            ...
            <div class="sub-banner">
                <div class="container">
                    <div class="text text-center">
                        <h2>ABOUT E-Ticketing Service</h2>
                ...
                <div class="about">
                    ...
                    <div class="about-item">
                        ...
                        <div class="img owl-single">
                            <img src="images/about/i1.jpg" alt="">
                            <img src="images/about/i2.jpg" alt="">
                        </div>

                        <div class="text">
                            <h2 class="heading">E-Ticketing Service</h2>
                            <div class="desc">
                    ...
                    <div class="about-item about-right">
                        ...
                        <div class="text">
                            <h2 class="heading">Why Choose E-Ticketing! </h2>
                            <div class="desc">
